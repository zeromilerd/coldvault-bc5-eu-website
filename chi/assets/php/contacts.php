...
$recipientEmail='nazishahmed04@gmail.com';
...
$senderSubject = 'New Subscription Message From' . $senderName . $senderEmail;
//$senderMessage = $_POST['contact-message'];
$senderMessage ="This message comes from subscription form";
...
if(!$mail->Send()) {
	...
	echo '<div class="alert alert-success" role="alert">Thank you for subscribing us. </div>';
}
?>